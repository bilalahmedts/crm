...
@push('header-buttons')
        <div class="col-lg-6 col-5 text-right">
          <a href="{{ route('home-warranties.index') }}" class="btn btn-sm btn-icon btn-neutral">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6" style="display: block" id="city">
                                    ...
                                    <input style="color: black" required type="text" name="city" data-id="city"
                                        class="form-control" placeholder="City" value="{{ $home_warranty->city }}"
                                        readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6" style="display: block;" id="client">
                                    ...
                                    <select name="status" {{-- onchange="selectClient(this.value)" --}} class="form-control selection_style"
                                        ...
                                        <option value="Accepted"
                                            @if ($home_warranty->status == 'Accepted' ||
                                                $home_warranty->status == 'Rejected' ||
                                                $home_warranty->status == 'Unsuccessful Transfer') disabled selected @endif>
                                            Accepted
                                        </option>
                                        ...
                                        <option value="Unsuccessful Transfer"
                                            @if ($home_warranty->status == 'Accepted' ||
                                                $home_warranty->status == 'Rejected' ||
                                                $home_warranty->status == 'Unsuccessful Transfer') disabled selected @endif>Unsuccessful
                                            Transfer
                                        </option>
