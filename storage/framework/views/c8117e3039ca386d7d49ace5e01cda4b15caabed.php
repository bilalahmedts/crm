                ...
                <div class="card bg-white shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small><?php echo e(__('labels.reset_password')); ?></small>
                        </div>
                        ...
                        <form role="form" method="POST" action="<?php echo e(route('password.email')); ?>">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-info my-4"><?php echo e(__('labels.send_password')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.login', ['class' => 'bg-secondary'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/crm.touchstone-communications.com/httpdocs/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>