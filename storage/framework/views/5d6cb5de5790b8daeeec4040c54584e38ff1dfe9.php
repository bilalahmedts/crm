                    ...
                    <div class="card-header border-0">
                        ...
                        <form action="<?php echo e(route('cmu-sales.import')); ?>" method="POST" id="webform"
                            ...
                            <div class="form-group">
                                <label class="form-control-label">Upload File</label><a href="<?php echo e(asset("cmu-sample-import-data-file.csv")); ?>" download>(Click here to download relevant file format)</a>
                                ...
                                <?php if(!$sales->isEmpty()): ?>
                                    <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <!--<td><?php echo e(@$row->user->HRMSID ?? 0); ?> </td>--> 
											<td><?php echo e(@$row->name ?? 'N/A'); ?></td>
											<td><?php echo e(@$row->hrms_id ?? 0); ?> </td>
                                            ...
                                            <?php if(in_array(Auth::user()->roles[0]->name, ['Super Admin'])): ?>
                                            <td width="3%">  
                                                <a href="<?php echo e(route('cmu-sales-delete', $row->id)); ?>" class="btn btn-warning btn-sm"><i class="fas fa-trash"></i></a>
                                            </td>
                                             <?php endif; ?>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', ['current_page' => 'cmu-sales-import-form'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/crm.touchstone-communications.com/httpdocs/resources/views/admin/cmu-sales/import-form.blade.php ENDPATH**/ ?>