                            ...
                            <div class="col-12">
                                <form action="<?php echo e(route('mortgages.index')); ?>" method="GET">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-lg-2 form-group">
                                            <label>Project</label>
                                            <select name="project_id" value="<?php echo e(@$_GET['project_id']); ?>" id="project_id"  class="form-control">
                                                <option value="">--Select--</option>
...
<?php echo $__env->make('admin.layouts.app', [ 'current_page' => 'mortgage' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crm\resources\views/admin/mortgage/index.blade.php ENDPATH**/ ?>