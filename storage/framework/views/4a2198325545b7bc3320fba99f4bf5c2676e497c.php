<div class="card shadow">
    <div class="card-header border-0">
        <div class="row align-items-center">
            <div class="col-8">
                <h3 class="mb-0"><?php echo e(__('labels.new_campaign')); ?></h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" action="<?php echo e(route('campaigns.store')); ?>" id="my-form" autocomplete="off">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH /var/www/vhosts/crm.touchstone-communications.com/httpdocs/resources/views/admin/campaign/partials/add_new_form.blade.php ENDPATH**/ ?>