        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('roles.update', $role->id)); ?>" id="my-form" autocomplete="off" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('labels.name')); ?>" value="<?php echo e(old('name', $role->name)); ?>" required autofocus>
                                ...
                                <div class="row permissions-select-wrapper">
                                    <?php $__empty_1 = true; $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="col-md-3 col-sm-6">
                                            <div class="custom-control custom-checkbox mb-3">
                                                <input class="custom-control-input permission-input-checkbox" id="setCheckboxPermission-<?php echo e($permission->id); ?>" name="permissions[]" type="checkbox" value="<?php echo e($permission->name); ?>" <?php echo e($role->hasPermissionTo($permission->name) ? 'checked' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', [ 'current_page' => 'roles' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/crm.touchstone-communications.com/httpdocs/resources/views/admin/role/edit.blade.php ENDPATH**/ ?>