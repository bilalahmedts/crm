                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-3">
                                <a href="<?php echo e(route('dss.create')); ?>" class="btn btn-info float-right m-1">Sale Submission</a>
...
<?php echo $__env->make('admin.layouts.app', [ 'current_page' => 'DSS ' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/crm.touchstone-communications.com/httpdocs/resources/views/admin/dss/index.blade.php ENDPATH**/ ?>